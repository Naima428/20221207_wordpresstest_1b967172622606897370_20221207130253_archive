...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221207_wordpresstest_1b967172622606897370_20221207130253_archive.zip';
        const ARCHIVE_SIZE       = '35148042';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '1b96717-07130253';
        const SECONDARY_PACKAGE_HASH = '3e74d4e-07130253';
        const VERSION            = '1.5.1';
